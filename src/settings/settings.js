...
const settings = {
    ...
    // ===TIME=== //
    LIVE_DELAY_BETWEEN_SOURCES_FETCH: 30000, // Number. Milliseconds. The delay time between fetching different sources data in live mode.
    ...
    // ===COUNTER=== //
    TRY_RECOVER_SOURCES_UPDATES_COUNT: 150, // Number. The number of updates to reach until it tries to fetch data from an error source.
    MAXIMUM_STATISTICS_ITEMS: 1000, // Number. The maximum number of statistics updates on the list to display.

    // ===LOCAL=== //
    SIMULATE_LOCAL_UPDATE_PERCENTAGE: 0.9, // Number. Determine the percentage of true/false chances to simulate the process of updating covid data. Example: 0.8 - true 80%/false 20%.
    SIMULATE_LOCAL_MAXIMUM_COUNTRIES_PER_ROUND: 5, // Number. Determine the maximum number of countries to update per round.
