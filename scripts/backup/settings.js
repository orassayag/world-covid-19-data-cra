...
const settings = {
    ...
    // (Working example: 'C:\\Or\\Web\\world-covid\\').
    ...
    // (Working example: 'C:\\Or\\Web\\world-covid\\world-covid\\').
    ...
    // (Working example: 'C:\\Or\\Web\\world-covid\\world-covid\\package.json').
    PACKAGE_JSON_PATH: 'package.json',
    // Determine the path of the package-lock.json.
    // (Working example: 'C:\\Or\\Web\\world-covid\\world-covid\\package-lock.json').
    PACKAGE_LOCK_JSON_PATH: 'package-lock.json',
    APPLICATION_NAME: 'world-covid', // Determine the application name used for some of the calculated paths.
    BACKUPS_PATH: 'backups', // Determine the backups directory which all the local backup will be created to.
    APPLICATION_PATH: 'world-covid', // All the these paths will be calculated during runtime in the initiate service.
